...
<html lang="fr">
<head>
  <title>Alexis Riou - Portfolio</title>
...
<body class="diag">
  ...
  <?php include('include/header-fixe.php'); ?>
          ...
          <div class="container content">
            <div class="row">
              <div class="blog-single col-md-8 col-md-offset-2">  
                ...
                <div class="blog-detail">Posté <span><time></time></span> par <span class='author'></div>
                <h2 class='description'></h2>
                <div class="blog-content text"></div>
              </div>
            </div>
          </div>
